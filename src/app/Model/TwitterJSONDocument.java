...
public class TwitterJSONDocument implements Document{
	...
	String[] keys = ApplicationSetup.getProperty("indexer.meta.forward.keys", "docno,text").split(",");
	String[] maxlengths = ApplicationSetup.getProperty("indexer.meta.forward.keylens", "32,200").split(",");
	...
	public TwitterJSONDocument(String JSONTweet) {
		this(parser.parse(JSONTweet).getAsJsonObject());
	}
