...
public class Features {
    ...
    public void setNumb_of_personal_pronouns(Double numb_of_personal_pronouns) {this.numb_of_personal_pronouns = numb_of_personal_pronouns;}
    public Double getNumb_of_present_tenses() {
        return numb_of_present_tenses;
    }
    public void setNumb_of_present_tenses(Double numb_of_present_tenses) { this.numb_of_present_tenses = numb_of_present_tenses;}


    public void setWeighted_length(Double weighted_length) {this.weighted_length = weighted_length; }
    public Double getWeighted_length(Double weighted_length) {return weighted_length; }

    public void setPermillage(Double permillage) {this.permillage = permillage;}
    public Double getPermillage(Double permillage) {return permillage;}
