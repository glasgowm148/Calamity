...
/**
  * This interface defines all the commands that the Eris aggregate supports.
 * <p>
 ...
 */
public interface ErisCommand extends Jsonable {
    /**
    ...
    @Value
    @JsonDeserialize
    final class UseGreetingMessage implements ErisCommand, CompressedJsonable {
    ...
    @Value
    @JsonDeserialize
    final class Hello implements ErisCommand {
