...
public class ConnectTwitter {
	...
	public static Twitter connectToTwitter() {
		...
		.setOAuthConsumerKey("ykXxGWF8w5oAF15eXPbnHgLcQ")
        .setOAuthConsumerSecret("6oVeqs9UXyR3TATnn7AvjmOuwZJs15iJBhnmWIjmKYZjYoBXzF")
        .setOAuthAccessToken("1107988224025284608-B7T30k9QE7bXy9DCHSoPekOJCoKr8H")
        .setOAuthAccessTokenSecret("jQ9hiZHGHF4Lxo9msBGqJO4SWFngDXYAmuYSwCYfYA42d");
