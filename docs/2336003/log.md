...
- TRECIS output format
- idStr output from java
- tfidf export
- exporting larger tweetset
- feature vector tidying / expanding

Figured out the input for the notebook. Mismatch between PDF and input was confusing me - Should be ['cat-string'] rather than ['0','1',...] 
